...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Duck02", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<Duck02Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Duck02 API v1");
